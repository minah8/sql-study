...
EXEC my_new_job_proc('JOB2', 'test_job2', 3000, 8000);
...
EXEC my_new_job_proc('JOB2', 'test job2', 10000, 12000);
...
BEGIN
    ...
    -- OUT 매개 변수에 조회 결과를 할당. -> 우리가 알고있는 return 개념과 같다.
    -- OUT 매개 변수에 값을 할당해 놓으면 프로시저 종료 후 호출부로 OUT 변수의 값이 전달됩니다.
    p_result := v_result;
